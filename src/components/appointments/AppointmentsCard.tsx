    ...
    try {
      ...
      const validAppointments: AppointmentData[] = (data || [])
        ...
        .map(apt => ({
          ...
          lead: apt.lead && typeof apt.lead === 'object' && 'author_name' in apt.lead 
            ? {
                author_name: apt.lead.author_name || 'Nom inconnu',
                company_name: apt.lead.company_name,
                unipile_company: apt.lead.unipile_company,
