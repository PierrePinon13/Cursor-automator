...
interface MultiSelectFilterProps {
  ...
  hideChevron?: boolean; // Permet de masquer la flèche déroulante
  highlightActive?: boolean; // Met en surbrillance le label si actif
}
  ...
  return (
    <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
      <DropdownMenuTrigger asChild>
        ...
        >
          <span className={highlightActive ? "font-semibold text-blue-700 bg-blue-50 rounded px-1" : ""}>{title}</span>
          {!hideChevron && (
